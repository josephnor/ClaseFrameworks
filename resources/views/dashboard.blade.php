...
<div class="app bg-gray-100">
    ...
    <div class="bg-white shadow rounded-lg mb-6">
            ...
            <div class="bg-white border border-white rounded-full float-right -mt-8 mr-0.5 flex shadow items-center ">
                ...
                <span class="text-sm ml-1 pr-1.5 text-gray-500">{{-- {{ $post->likes->count()}} --}}</span>
                ...
                <div class="relative flex items-center self-center w-full max-w-xl p-4 overflow-hidden text-gray-600 focus-within:text-gray-400">
                    ...
                    <img class="w-10 h-10 object-cover rounded-full shadow mr-2 cursor-pointer" alt="User avatar" src="https://scontent.fbga1-4.fna.fbcdn.net/v/t1.6435-9/78358936_2772741366103467_9174168625223827456_n.jpg?_nc_cat=111&ccb=1-7&_nc_sid=09cbfe&_nc_eui2=AeGdOqajw0NIuryXg_TwJCs4AMeqj0UjN6kAx6qPRSM3qeCuQ5R1rjBz3Etu7DAiMUkR5sg3jRtOtjDQ1kX_Ha_o&_nc_ohc=yIEE27OKiSwAX_5KPq_&_nc_ht=scontent.fbga1-4.fna&oh=00_AfDNN2cgpDmHkSXVZg5O4RDIJ4FKw7E0qDnMhkZFU4dKTw&oe=645E8B02">
                    <span class="absolute inset-y-0 right-0 flex items-center pr-6">
                        ...
                        <input type="search" name="textoComentario" class="w-full py-2 pl-4 pr-10 text-sm bg-gray-100 border border-transparent appearance-none rounded-tg placeholder-gray-400" style="border-radius: 25px" placeholder="Post a comment..." autocomplete="off">
                </div>
            </div>
            </form>
