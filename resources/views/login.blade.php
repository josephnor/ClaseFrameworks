...
<body>
    <section class="h-screen">
        ...
        <div class="px-6 h-full text-black bg-sky-900">
          <div
          ...
          >
            ...
            >
              <img
                src="https://unidaddeinvestigacion.ustabuca.edu.co/images/imagenes%20investi/LOGO-50-educont_V2.png"
                class="w-full"
                alt="Sample image"
              />
            </div>
                    ...
                    @if(session('mensaje'))
                      <!--<p class= "bg-red-600 text-white my-2 text-sm p-2 text-center">-->
                        <div class="flex p-4 mb-4 text-sm text-red-800 rounded-lg bg-red-50 dark:bg-gray-800 dark:text-red-400" role="alert">
                          ...
                          <div>
                            <span class="font-extrabold"></span>{{session('mensaje')}}
                          </div>
                        </div>
                         <!--</p>-->
                    @endif
